...
\subsection[]{Solving the repetition code using Poulin's methods}
What are my test cases? If I have channels that have no error, what should my output values be? If I'm decoding the physial qubit atleast. 